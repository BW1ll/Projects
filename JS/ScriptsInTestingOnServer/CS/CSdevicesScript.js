 ...
 * 
 * Convert double sided sheet cost to single sided so that the Sheet limit will
 * accurate.
 * 
...
function devicePrintReleaseHook(inputs, actions) {
    ...
    var MAX_SHEETS_PER_MONTH = 600; // change this to the montly sheet limit and in deviceJobLogHook below
