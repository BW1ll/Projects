 ...
 * 
 * Convert double sided sheet cost s for copy jobs to single sided so that the Sheet limit will
 * accurate.
 * 
...
function devicePrintReleaseHook(inputs, actions) {
    ...
    var MAX_SHEETS_PER_MONTH = 1000; // change this to the montly sheet limit and in deviceJobLogHook below
